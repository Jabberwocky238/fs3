...
pub trait ObjectLegalHoldS3Handler: Send + Sync {
    ...
    async fn get_object_legal_hold(&self, req: GetObjectLegalHoldRequest) -> Result<GetObjectLegalHoldResponse , BoxError> {
    ...
    async fn put_object_legal_hold(&self, req: PutObjectLegalHoldRequest) -> Result<PutObjectLegalHoldResponse , BoxError> {
