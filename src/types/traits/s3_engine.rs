    ...
    E: StdError,
{
    async fn get_object_retention(
        ...
        bucket: &str,
        key: &str,
    ) -> Result<Option<ObjectRetention>, E>;
    ...
    E: StdError,
{
    async fn get_object_legal_hold(
        ...
        bucket: &str,
        key: &str,
    ) -> Result<Option<ObjectLegalHold>, E>;
    ...
    E: StdError,
{
    async fn get_bucket_object_lock_config(
        &self,
        bucket: &str,
    ) -> Result<Option<BucketObjectLockConfig>, E>;
    ...
    E: StdError,
{
    ...
    async fn validate_bucket_replication_creds(
        &self,
        bucket: &str,
    ) -> Result<ReplicationCredsValidation, E>;
}
    ...
    E: StdError,
{
    async fn get_bucket_tagging(
        &self,
        bucket: &str,
    ) -> Result<Option<std::collections::HashMap<String, String>>, E>;
    ...
    E: StdError,
{
    ...
    async fn set_bucket_cors(&self, bucket: &str, cors: Option<CorsConfiguration>)
    -> Result<(), E>;
}
    ...
    E: StdError,
{
    ...
    async fn get_object(
        ...
        key: &str,
        options: ObjectReadOptions,
    ) -> Result<(S3Object, BoxByteStream), E>;
    async fn put_object(
        &self,
        bucket: &str,
        key: &str,
    ...
    E: StdError,
{
    ...
    async fn list_multipart_uploads(
        ...
        bucket: &str,
        options: ListOptions,
    ) -> Result<Vec<MultipartUpload>, E>;
}

pub trait S3Engine<E>:
    S3BucketEngine<E> + S3ObjectEngine<E> + S3MultipartEngine<E> + Send + Sync
where
    E: StdError,
{
}
