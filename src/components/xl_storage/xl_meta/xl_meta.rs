/// XlMetaV2 主结构 - 对应 MinIO xlMetaV2
use super::types::*;
...
impl XlMetaV2 {
    ...
    fn encode_payload(&self) -> Result<Vec<u8>, Box<dyn std::error::Error>> {
        ...
        for ver in &self.versions {
            let h = XlMetaV2VersionHeader::from_version(ver);
    ...
    fn decode_payload(payload: &[u8], minor: u16) -> Result<Vec<XlMetaV2Version>, Box<dyn std::error::Error>> {
        use std::io::Cursor;
