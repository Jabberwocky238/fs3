...
mod tests {
    ...
    fn test_case_1() {
        ...
        let expected =
            hex::decode("82a24944c4100102030405060708090a0b0c0d0e0f10a54d54696d65d2499602d2")
                .unwrap();
    ...
    fn test_case_3() {
        ...
        let rust_bytes: Vec<u8> = obj.into();
        let expected =
            hex::decode("82a24944c410deadbeefcafebabe123456789abcdef0a54d54696d6500").unwrap();
        assert_eq!(rust_bytes, expected);
    }
}
